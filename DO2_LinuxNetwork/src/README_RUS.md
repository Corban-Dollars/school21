...
![скрин 1.4](PNG/2.1.PNG)

##### С помощью команды `ip a` посмотри существующие сетевые интерфейсы.
- В отчёт помести скрин с вызовом и выводом использованной команды.
  
ws1  
![скрин 1.4](PNG/2.2ws1.PNG)   

ws2  
![скрин 1.4](PNG/2.2ws2.PNG)   
...
ws1    
![скрин 1.4](PNG/2.3ws1.PNG)   

ws2    
![скрин 1.4](PNG/2.3ws2.PNG)   
...
ws1    
![скрин 1.4](PNG/2.4ws1.PNG)   

ws2    
![скрин 1.4](PNG/2.4ws2.PNG)   
...
ws1    
![скрин 1.4](PNG/2.5ws1.PNG)   

ws2    
![скрин 1.4](PNG/2.5ws2.PNG)   

##### Пропингуй соединение между машинами.
- В отчёт помести скрин с вызовом и выводом использованной команды.

ws1    
![скрин 1.4](PNG/2.6ws1.PNG)   

ws2    
![скрин 1.4](PNG/2.6ws2.PNG)   
...
ws1    
![скрин 1.4](PNG/3.1ws1.PNG)   

ws2    
![скрин 1.4](PNG/3.1ws2.PNG)   

В качестве сервера выступает ws1, а клиента ws2.

ws1    
![скрин 1.4](PNG/3.2ws1.PNG)   

ws2    
![скрин 1.4](PNG/3.2ws2.PNG)   
...
ws1    
![скрин 1.4](PNG/4.1ws1.PNG)   

ws2    
![скрин 1.4](PNG/4.1ws2.PNG)   

##### Запусти файлы на обеих машинах командами `chmod +x /etc/firewall.sh` и `/etc/firewall.sh`.
- В отчёт помести скрины с запуском обоих файлов;

ws1    
![скрин 1.4](PNG/4.2ws1.PNG)   

ws2    
![скрин 1.4](PNG/4.2ws2.PNG)   
...
ws1    
![скрин 1.4](PNG/4.3ws1.PNG)   

ws2    
![скрин 1.4](PNG/4.3ws2.PNG)   
...
r1     
![скрин 1.4](PNG/5.2r1.PNG)  

r2     
![скрин 1.4](PNG/5.2r2.PNG)  

ws11       
![скрин 1.4](PNG/5.2ws11.PNG)  

ws21     
![скрин 1.4](PNG/5.2ws21.PNG)  

ws22     
![скрин 1.4](PNG/5.2ws22.PNG)  

##### Перезапусти сервис сети. Если ошибок нет, то командой `ip -4 a` проверь, что адрес машины задан верно. Также пропингуй ws22 с ws21. Аналогично пропингуй r1 с ws11.
- В отчёт помести скрины с вызовом и выводом использованных команд.

r1     
![скрин 1.4](PNG/5.2.2r1.PNG)  

r2     
![скрин 1.4](PNG/5.2.2r2.PNG)  

ws11       
![скрин 1.4](PNG/5.2.2ws11.PNG)  

ws21     
![скрин 1.4](PNG/5.2.2ws21.PNG)  

ws22     
![скрин 1.4](PNG/5.2.2ws22.PNG)  

Пинг с ws21 на ws22    
![скрин 1.4](PNG/5.2.2ws21pingws22.PNG)  

Пинг с ws11 на r1      
![скрин 1.4](PNG/5.2.2ws11pingr1.PNG)  
...
r1     
![скрин 1.4](PNG/5.3r1.PNG)  

r2     
![скрин 1.4](PNG/5.3r2.PNG)  
...
r1     
![скрин 1.4](PNG/5.3.1r1.PNG)  

r2     
![скрин 1.4](PNG/5.3.1r2.PNG)  
...
ws11     
![скрин 1.4](PNG/5.3.2ws11.PNG)  

ws21     
![скрин 1.4](PNG/5.3.2ws21.PNG)  

ws22     
![скрин 1.4](PNG/5.3.2ws22.PNG)  

##### Вызови `ip r` и покажи, что добавился маршрут в таблицу маршрутизации.
- В отчёт помести скрин с вызовом и выводом использованной команды.

ws11     
![скрин 1.4](PNG/5.3.3ws11.PNG)  

ws21     
![скрин 1.4](PNG/5.3.3ws21.PNG)  

ws22     
![скрин 1.4](PNG/5.3.3ws22.PNG)  
...
ws11     
![скрин 1.4](PNG/5.3.4ws11.PNG)  

r2       
![скрин 1.4](PNG/5.3.4r2.PNG)  
...
```
r1     
![скрин 1.4](PNG/5.4.0r1.PNG)  

r2     
![скрин 1.4](PNG/5.4.0r2.PNG)  
...
r1     
![скрин 1.4](PNG/5.4.1r1.PNG)  

r2     
![скрин 1.4](PNG/5.4.1r2.PNG)  
...
ws11     
![скрин 1.4](PNG/5.5.0ws11.PNG)  

r2       
![скрин 1.4](PNG/5.5.0r1.PNG)  
...
ws11     
![скрин 1.4](PNG/5.6ws11.PNG)  

r1       
![скрин 1.4](PNG/5.6r1.PNG)  
...
r1   
![скрин 1.4](PNG/7.1r1.PNG)  

ws22   
![скрин 1.4](PNG/7.1ws22.PNG)  

##### Запусти веб-сервер Apache командой `service apache2 start` на ws22 и r1.
- В отчёт помести скрины с вызовом и выводом использованной команды.

r1       
![скрин 1.4](PNG/7.2r1.PNG)  

ws22     
![скрин 1.4](PNG/7.2ws22.PNG)  
...
r1         
![скрин 1.4](PNG/7.4r1.PNG)  

##### Добавь в файл ещё одно правило:
##### 4) Разрешить маршрутизацию всех пакетов протокола **ICMP**.

r2          
![скрин 1.4](PNG/7.4r2.PNG)    
sudo nano /etc/firewall.sh     
sudo chmod +x /etc/firewall.sh     
sodu sh /etc/firewall.sh     
...
ws22                 
![скрин 1.4](PNG/7.6ws22.PNG)    

r1                   
![скрин 1.4](PNG/7.6r1.PNG)    
...
ws21                   
![скрин 1.4](PNG/8.2ws22.PNG)    
ssh -L 8080:10.20.0.20:80 melnitsh@localhost     
  
ws21                 
![скрин 1.4](PNG/8.3ws22.PNG)    
sudo telnet 127.0.0.1 8080     
 
ws11                   
![скрин 1.4](PNG/8.4ws11.PNG)    
ssh -L 8080:10.20.0.20:80 melnitsh@localhost       
  
ws11                  
![скрин 1.4](PNG/8.5ws11.PNG)    
sudo telnet 127.0.0.1 8080     
